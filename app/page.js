...
export default function Home() {
  return (
    ...
    <div className="main flex-col md:flex-row flex w-[95vw] md:w-[99vw] h-[70vh] rounded-lg py-10 mx-2 my-10 bg-purple-100">
      <div className="left w-full md:w-1/2 h-full flex flex-col justify-center items-center">
        <p className="font-bold text-3xl">Shorten your URL here.</p>
        <p className="text-gray-400 text-center">You can shorten your URL here without login or credentials.</p>
